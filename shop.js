...
function buyAd() {
 if (userMoney < adCost) {
  alert(
   "You don't have enough sweets! You have only" +
   userMoney +
   "sweets! You must have" + adCost +
   "sweets.");
...
function buyShelves() {
 if (userMoney < 10000000) {
  alert(
   "You don't have enough sweets! You have only" +
   userMoney +
   "sweets! You must have 10000000 sweets."
  );
...
function buyCashregister() {
 if (userMoney < 15000000) {
  alert(
   "You don't have enough sweets! You have only" +
   userMoney +
   "sweets! You must have 15000000 sweets."
  );
...
function buyFloors() {
 if (userMoney < 20000000) {
  alert(
   "You don't have enough sweets! You have only" +
   userMoney +
   "sweets! You must have 20000000 sweets."
  );
...
function buyWalls() {
 if (userMoney < 25000000) {
  alert(
   "You don't have enough sweets! You have only" +
   userMoney +
   "sweets! You must have 25000000 sweets."
  );
...
function buyWindows() {
 if (userMoney < 30000000) {
  alert(
   "You don't have enough sweets! You have only" +
   userMoney +
   "sweets! You must have 30000000 sweets."
  );
...
function buyRoof() {
 if (userMoney < 35000000) {
  alert(
   "You don't have enough sweets! You have only" +
   userMoney +
   "sweets! You must have 35000000 sweets."
  );
...
function buyStock() {
 if (userMoney < 40000000) {
  alert(
   "You don't have enough sweets! You have only" +
   userMoney +
   "sweets! You must have 40000000 sweets."
  );
...
function buyTransport() {
 if (userMoney < 45000000) {
  alert(
   "You don't have enough sweets! You have only" +
   userMoney +
   "sweets! You must have 45000000 sweets."
  );
...
function openShop() {
 ...
 if (userMoney < 100000000) {
  alert(
   "You don't have enought sweets to open shop!"
  );
  return;
 }
 document.getElementById("shopStatus")
